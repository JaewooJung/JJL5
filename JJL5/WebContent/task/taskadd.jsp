...
<label>프로젝트 번호 </label>
<input name="pno" value="${pno}" readonly><br>
<label>제목</label>
<input type="text" name="title"><br>
<label>파일업로드</label>
<input type="file" name="uiprotourl"><br><br>
<label>내용</label>
...
<input type="submit" class="btn btn-primary pull-right" value="작업 추가">
